  ...
  <el-container>
    ...
    <el-main>
      ...
      <el-row type="flex" justify="end">
        <el-col :span="3">
          <el-button type="danger" v-if="this.$store.getters.user.isAdmin" @click="clearLog(searchParams)">清空日志</el-button>
        </el-col>
        <el-col :span="2">
...
export default {
  ...
  methods: {
    ...
    clearLog (searchParams) {
      this.$appConfirm(() => {
        taskLogService.clear(searchParams.task_id, () => {
